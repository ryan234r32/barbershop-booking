...
### Phase 3：Rich Menu 6 格改版 ✅ 已正式上線（2026-05-07）
...
| 3.2 | LINE Messaging API 上傳 Rich Menu image + 設定 area mapping | Codex | ✅ 已正式設為 default |
...
- [ ] 手機端 LINE 主畫面 Rich Menu 顯示 6 格（需 LINE client 快取刷新）
