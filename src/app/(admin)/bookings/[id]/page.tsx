    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span
            className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${STATUS_COLORS[booking.status] || "bg-gray-100 text-gray-700"}`}
          >
        ...
        <section className="bg-white rounded-xl shadow-sm border p-5 mb-4">
          <h2 className="text-sm font-medium text-gray-500 mb-3">服務項目</h2>
        ...
        <section className="bg-white rounded-xl shadow-sm border p-5 mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <p className="text-xs text-gray-400">時段</p>
              <p className="text-base font-medium text-gray-900 mt-0.5">
        ...
        {/* Customer Info */}
        <section className="bg-white rounded-xl shadow-sm border p-5 mb-4">
          <h2 className="text-sm font-medium text-gray-500 mb-3">顧客資訊</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
            ...
            <div>
              <p className="text-xs text-gray-400">客群</p>
              <p className="text-base font-medium text-gray-900 mt-0.5">
            ...
            <div>
              <p className="text-xs text-gray-400">預約來源</p>
              <p className="text-base font-medium text-gray-900 mt-0.5">
        ...
        {booking.notes && (
          <section className="bg-white rounded-xl shadow-sm border p-5 mb-4">
            <h2 className="text-sm font-medium text-gray-500 mb-2">備註</h2>
        ...
        {/* Payment */}
        <section className="bg-white rounded-xl shadow-sm border p-5 mb-4">
          <h2 className="text-sm font-medium text-gray-500 mb-3">付款資訊</h2>
          {booking.payment ? (
            ...
            <p className="text-gray-400 text-sm">尚無付款紀錄</p>
          )}
        </section>

        {/* Booking History */}
        <section className="bg-white rounded-xl shadow-sm border p-5 mb-4">
          <h2 className="text-sm font-medium text-gray-500 mb-3">預約紀錄</h2>
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 rounded-full bg-gray-400 mt-1.5 shrink-0" />
              <div>
                <p className="text-sm text-gray-700">建立預約</p>
                <p className="text-xs text-gray-400">
            ...
            {booking.status === "COMPLETED" && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-700">服務完成</p>
                </div>
              </div>
            )}
            {booking.status === "CANCELLED" && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-700">預約已取消</p>
                </div>
              </div>
            )}
            {booking.status === "NO_SHOW" && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-700">顧客未到店</p>
                </div>
              </div>
            )}
            {booking.payment?.status === "CONFIRMED" &&
              booking.payment.confirmedAt && (
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-green-500 mt-1.5 shrink-0" />
                  <div>
                    <p className="text-sm text-gray-700">付款已確認</p>
                    <p className="text-xs text-gray-400">
          ...
          <section className="bg-white rounded-xl shadow-sm border p-5 mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                disabled={actionLoading !== null}
                className="flex-1 px-4 py-2.5 bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-50"
              >
                標記未到
              </button>
              <button
